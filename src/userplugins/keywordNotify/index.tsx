...
import { MessageJSON } from "discord-types/general/index.js";
...
export default definePlugin({
    ...
    applyKeywordEntries(m: MessageJSON) {
        let matches = false;
        ...
        for (const entry of keywordEntries) {
            ...
            if (settings.store.ignoreBots &&
                // @ts-ignore for some reason, bot doesn't exist
                m.author.bot &&
        ...
        if (matches || (
            ...
            m.referenced_message.author.id === UserStore.getCurrentUser()?.id &&
            settings.store.replies
        )) {
